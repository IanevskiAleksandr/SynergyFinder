...
$( document ).ready(function() {
    ...
    tour.addSteps([
      ...
      element: "#buttonTour",
      title: "Welcome!", 
      content: "Welcome to SynergyFinder exploration tour. <br>It will indroduce you to our application by <br>walking through it step by step.",
	  placement: "bottom"
	  },
	    {
    element: "#videobt",
    title: "User guide",
    content: "Before using the application please <br>read the <a style='cursor: pointer;' onclick='javascript:techdoc()'>technical documentation</a> and<br>watch a <a style='cursor: pointer;' onclick='javascript:openvideo()'>video tutorial</a>",
	placement: "bottom"  
  },
  { 
    element: "#annotfileid",
    title: "Data submittion!",
    content: "Your first task is to upload your dataset.<br>For more information about input data see<br> <b>section 3</b> in <a style='cursor: pointer;' onclick='javascript:techdoc()'>technical documentation</a><br>or <a style='cursor: pointer;' onclick='javascript:openvideo()'>video tutorial</a>"
  },
  {
      element: "#tourfileformat",
      title: "Data submittion!", 
      content: "Before uploading your dataset, please<br> specify the format in which you<br>provide your data. (Default: Table)<br>See <b>section 3</b> in <a style='cursor: pointer;' onclick='javascript:techdoc()'>technical documentation</a><br>or <a style='cursor: pointer;' onclick='javascript:openvideo()'>video tutorial</a> for more information.",
	  placement: "bottom"
	  },
  {
    element: "#selInhVia",
    title: "Readout!",
    content: "Once the data are loaded, you have to specify a readout,<br> which indicates whether %inhibition or %viability data <br>are provided as a response.",
	onShown: function (tour) { var aaa = Math.round(new Date().getTime()/1e3); Shiny.onInputChange("drdatatour", { aaa }); }
  },
  
  {
    element: "#toursliderdr",
    title: "Dose-response data!",
    content: "After selecting a readout, you may visualize <br>a data you provided.",
	onShown: function (tour) { var aaa = Math.round(new Date().getTime()/1e3); Shiny.onInputChange("selInhViatour", { aaa }); },
	onPrev: function (tour) { var aaa = Math.round(new Date().getTime()/1e3); Shiny.onInputChange("dropselInhViatour", { aaa }); }
  },
  
  {
    element: "#plotA102",
    title: "Input response data!",
    content: "Here you can see visualization of your input data.<br>Each of the drug pairs are shown into separate tabs.<br>Individual drugs (response curves) and combined response<br>matrices are depicted for all combinations.",
	placement: "left",
	onShown: function (tour) { var aaa = Math.round(new Date().getTime()/1e3); $("#wraptour").hide(); Shiny.onInputChange("vizdrdata", { aaa }); }
  },
  
  {
    element: "#tourcalcsyn",
    title: "Calculate synergy!",
    content: "In order to calculate synergy scores for each of<br>drug combinations click 'Calculate synergy' toggle button",
	placement: "right",
	onShown: function (tour) { var aaa = Math.round(new Date().getTime()/1e3); Shiny.onInputChange("selInhViatour", { aaa }); },
  ...
  {
    element: "#tourmodels",
    title: "Visualize synergy!",
    content: "Then choose one of four combination intercation models (methods) <br> and whether correction should be applied.",
	placement: "right",
	onPrev: function (tour) { var aaa = Math.round(new Date().getTime()/1e3);  Shiny.onInputChange("switch2off", { aaa }); }
  },
  
  {
    element: "#tourvizsyn",
    title: "Visualize synergy!",
    content: "Now you are <b>ready</b> to calculate synergy scores and<br>visualize synergy maps. Just click 'Visualize synergy scores' toggle button.<br>Progress bar in the bottom right corner will indicate the process of calculations.",
	placement: "right",
	onNext: function (tour) { var aaa = Math.round(new Date().getTime()/1e3); Shiny.onInputChange("showmaps", { aaa }); }
  },
  
  {
    element: "#plotsyn2",
    title: "Calculated synergy maps!",
    content: "Here you can see visualization of calculated synergy maps.<br>Each of the drug pairs are shown into separate tabs.<br>2D and 3D synergy maps are shown.<br>You may <b>zoom</b>(both), <b>rotate</b>(3D), <b>save</b>(both), <br><b>calculate score corresponding to this specific dose region</b>(2D)",
	placement: "left",
	onPrev: function (tour) { var aaa = Math.round(new Date().getTime()/1e3); Shiny.onInputChange("closeshowedmaps", { aaa }); }
  },
  
  {
    element: "#Save_report",
    title: "Save report!",
    content: "Now you can save your results as a single report.<br>as a static/dynamic PDF report or export a table of synergy scores",
	placement: "right"  
  },
